    ...
    function afficheCatalogue (){
        albums.forEach((albums)=>{
            ...
            <div class="carte col-6 col-lg-3 col-xl-2 mb-3">
            <div class="card h-100 bg-secondary text-white">
                    <a href="detail_BD.html?auteur=${auteur.nom}&serie=${serie.nom}&prix=${prix}&numero=${num}&titre=${titre}"><img src="images/albumsMini/${nomfichier}.jpg" class="card-img-top rounded mt-2 px-3 " alt="..." id="imageAlbum"></a>
